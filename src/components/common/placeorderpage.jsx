...
function PlaceOrderPage() {
    ...
    useEffect(() => {
        ...
        if (!accessToken) {
            ...
            message.error("You are not allowed to place order");
            navigate('/delivery');
                                        ...
                                        <Radio.Group className="vehicle-radio-group" onChange={handleServiceSelect}>
                                            {fetchedServices.map(service => (
                                                <Radio key={service.transportServiceId} value={service.transportServiceId}>
                                                    {service.type === "road" && (
                                                        <img src='src/images/truck.png' alt="Road" style={{ width: '80px', height: '80px' }} />
                                                    )}
                                                    {service.type === "air" && (
                                                        <img src='src/images/plane.png' alt="Air" style={{ width: '80px', height: '80px' }} />
                                                    )}
